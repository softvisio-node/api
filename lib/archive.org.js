...
export default class ArchiveOrg extends ThreadsRunner {
    #_agent;
    ...
    async getIndex ( domain, options = {} ) {
        ...
        const res = await this.runThread( this._thread.bind( this ), url );
    ...
    async getSnapshot ( domain, timestamp ) {
        ...
        return await this.runThread( this._thread.bind( this ), url );
    }
