...
export default class Moz extends ThreadsRunner {
    #apiUser;
    #apiKey;
    ...
    async getAnchorText ( target, scope, options = {} ) {
        return this.runThread( this._thread.bind( this ), "anchor_text", { target, scope, "limit": options.limit || null } );
    }
    ...
    async getUrlMetrics ( url, options = {} ) {
        return this.runThread( this._thread.bind( this ), "url_metrics", {
