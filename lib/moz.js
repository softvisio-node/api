...
export default class Moz extends ThreadsPool {
    ...
    constructor ( apiUser, apiKey, options = {} ) {
        ...
        this.maxThreads = this.#free ? 1 : options.maxThreads || DEFAULT_MAX_THREADS;
    }
    ...
    async getAnchorText ( target, scope, options = {} ) {
        return this.addThread( this.#thread.bind( this ), "anchor_text", { target, scope, "limit": options.limit || null } );
    }
    ...
    async getUrlMetrics ( url, options = {} ) {
        return this.addThread( this.#thread.bind( this ), "url_metrics", {
