...
export default class Moz extends ThreadsPool {
    ...
    constructor ( apiUser, apiKey, options = {} ) {
        ...
        this.maxRunningThreads = this.#free ? 1 : options.maxRunningThreads || DEFAULT_MAX_RUNNING_THREADS;
    }
    ...
    get #agent () {
        this.#_agent ??= new fetch.Dispatcher();
    ...
    async getAnchorText ( target, scope, options = {} ) {
        return this.runThread( this.#thread.bind( this ), "anchor_text", { target, scope, "limit": options.limit || null } );
    }
