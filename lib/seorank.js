...
import ThreadsRunner from "#core/threads/runner";

// NOTE https://seo-rank.my-addr.com/how-to-use-bulk-and-api-checker.php

const DEFAULT_MAX_THREADS = 5;

export default class SeoRank extends ThreadsRunner {
    #apiKey;
    ...
    async getMoz ( domain ) {
        return this.runThread( this._thread.bind( this ), `https://seo-rank.my-addr.com/api2/moz/${this.#apiKey}/${domain}` );
    }

    // XXX up to 40 threads
    // XXX do not use this shit
    async getMajestic ( url ) {
        return this.runThread( this._thread.bind( this ), `https://seo-rank.my-addr.com/api3/${this.#apiKey}/${url}` );
    }
