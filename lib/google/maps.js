...
export default class GoogleMapsApi {
    ...
    async placesDetails ( placeId, { language = "en" } = {} ) {
        return this.#request( "place/details", `place/details:${language}:${placeId}`, { "place_id": placeId, language }, "result" );
    }

    // https://developers.google.com/maps/documentation/places/web-service/search-find-place
    async placesFindFromText ( text, { language = "en" } = {} ) {
        return this.#request( "place/findplacefromtext",
            null,
            {
                "input": text,
                "inputtype": "textquery",
    ...
    async placesAutocomplete ( text, { components, language = "en", location, types } = {} ) {
        return this.#request( "place/autocomplete",
            null,
            {
                "input": text,
